...
За да стартираме приложението си ще ползваме командите, които Golang компилатора ни предоставя. Затова смело отворете вашата конзола и се позиционирайте в директорията на вашия проект